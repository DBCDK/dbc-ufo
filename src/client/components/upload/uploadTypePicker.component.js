    ...
    return (
      <div>
        ...
        <div className="buttons flex">
          <div className="text-button" onClick={() => this.props.onClick(constants.UPLOAD_TYPE_IMAGE)}>
          ...
          <div className="text-button" onClick={() => this.props.onClick(constants.UPLOAD_TYPE_URL)}>
